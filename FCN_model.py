...
# 测试不同的网络模型VGG-19，VGG-16，13，11；ResNet；GoogleNet。
def inference(image, num_of_class, weights, keep_prob):
    ...
    with tf.variable_scope('inference'):
        ...
        pool3 = pool_layer('pool3', conv3_3, 2, 2, 2, 2, 'SAME', tf.nn.avg_pool)
        ...
        pool4 = pool_layer('pool4', conv4_3, 2, 2, 2, 2, 'SAME', tf.nn.avg_pool)
        ...
        pool5 = pool_layer('pool5', conv5_3, 2, 2, 2, 2, 'SAME', tf.nn.max_pool)
...
def statistics(prediction, annotation):
    ...
    return precesion, recall, f_score, mcc,IoU
