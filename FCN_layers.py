...
def conv_layer(layer_name, input_tensor, filter_height, filter_width, in_channels, out_channels,
    ...
    with tf.variable_scope(layer_name):
        ...
        if activation_function is None: # 4.27zj
          layer_out = conv_add 
        elif activation_function is tf.nn.leaky_relu:
          layer_out = activation_function(conv_add, alpha=0.1, name='layer_out') # 如何设置参数？
        else:
